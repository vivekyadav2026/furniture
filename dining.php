<?php
$page_title = "Designer Dining Collection | FurnishHut Palatial Dining";
$page_description = "Explore FurnishHut's luxury dining collection. Hand-carved mahogany tables, marble banquet tables, and silk upholstered royal dining chairs.";
include 'header.php';
?>
  ...
  <section class="relative py-24 bg-luxeCream overflow-hidden flex items-center justify-center">
    <div class="absolute inset-0 z-0">
      <img src="assets/img/Dining_furniture/04-Seater-Royal-Dining-Table-Set-at-Factory-Price-1.webp" alt="Designer Dining Collection Header" class="w-full h-full object-cover ">
    ...
    <div class="container relative z-10 text-center px-4 max-w-3xl">
      <div class="glass-panel py-6 px-8 inline-block border border-[rgba(197,168,128,0.35)] shadow-lg">
        <span class="text-luxeGold text-xs font-semibold tracking-[0.4em] uppercase block mb-2">PALATIAL DINING HALLS</span>
        <h1 class="text-3xl md:text-5xl font-bold font-heading text-luxeBlack tracking-wide m-0">Designer Dining Collection</h1>
      </div>
    </div>
  </section>
  ...
  <section class="py-24 bg-luxeCream">
    <div class="container mx-auto px-4 max-w-7xl">
      <div class="row g-5">
<?php
$folder_path = "assets/img/Dining_furniture/";
$images = [];
