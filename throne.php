<?php
$page_title = "Royal Throne Chairs | FurnishHut Accent Seating";
$page_description = "Discover FurnishHut's imperial throne chairs. Hand-carved Maharaja chairs, gold-leaf accent seating, and custom baroque lobby chairs.";
include 'header.php';
?>
  ...
  <section class="relative py-24 bg-luxeCream overflow-hidden flex items-center justify-center">
    <div class="absolute inset-0 z-0">
      <img src="assets/img/gurujichair/Designer-Chair-With-Hawk-Design-legs-scaled.webp" alt="Throne Chairs Header" class="w-full h-full object-cover ">
    ...
    <div class="container relative z-10 text-center px-4 max-w-3xl">
      <div class="glass-panel py-6 px-8 inline-block border border-[rgba(197,168,128,0.35)] shadow-lg">
        <span class="text-luxeGold text-xs font-semibold tracking-[0.4em] uppercase block mb-2">ACCENT STATEMENT FOCAL POINTS</span>
        <h1 class="text-3xl md:text-5xl font-bold font-heading text-luxeBlack tracking-wide m-0">Throne Chairs</h1>
      </div>
    </div>
  </section>
